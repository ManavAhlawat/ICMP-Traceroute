...
import select
import binascii
# use mac or linux terminal to run code using sudo Python
testing.py
ICMP_ECHO_REQUEST = 8
MAX_HOPS = 30
TIMEOUT = 2.0
...
appended to the header and
 # then finally the complete packet was sent to the
destination.
...
myChecksum, myID, 1)
 #header = struct.pack("!HHHHH", ICMP_ECHO_REQUEST, 0,
myChecksum, pid, 1)
...
request_type, code, checksum, packetID, sequence
